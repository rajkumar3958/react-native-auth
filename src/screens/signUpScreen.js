        ...
        <SafeAreaView style={{paddingHorizontal:20,flex:1,backgroundColor:COLORS.white}}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{marginTop:20}}>
                    ...
                    <Ionicons style={STYLES.inputIconr} name='person-outline' size={20} color={COLORS.light}></Ionicons>
                    <TextInput placeholder='Name' style={STYLES.imput}></TextInput>
                    </View>
                </View>
                <View style={{marginTop:20}}>
                    <View style={STYLES.inputContainer}>
                ...
                <View style={STYLES.btnPrimary}>
                    <Text style={{color:COLORS.white, fontWeight:'bold',fontSize:18}}>SignUp</Text>
                </View>
